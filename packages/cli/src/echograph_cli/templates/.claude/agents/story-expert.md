...
3. **Conversion to Technical Specs**: Developers use `/convert-story` to generate SPEC.md (technical feature request)
4. **PRP Generation**: SPEC.md is then used to generate comprehensive implementation plans (PRPs)
