...
- [ ] [TASK-001] Example feature implementation (1/7) → @.claude/tasks/TASK-001-example-feature.md

## Pending

_(Add new tasks here as they are planned)_

## Completed

_(Completed tasks will be moved here automatically when all subtasks are done)_
